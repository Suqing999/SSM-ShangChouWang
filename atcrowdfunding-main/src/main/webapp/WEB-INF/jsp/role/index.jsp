        ...
        <script type="text/javascript">
        	...
        	function initShow(result){
        		...
        		$.each(list,function(i,e){
        			...
        			content+='    <td>';
        			content+='		<button type="button" roleId="'+e.id+'" class="assignPermisionClass btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
            ...
            //==============给角色分配权限开始 =======================
            	...
            	var roleId  = '';
            	$("tbody").on('click',".assignPermisionClass",function(){
            		//显示模态框
	          		$("#assignModal").modal({
	          			show:true,
	          			backdrop:'static',
                		...
                		$.get("${PATH}/role/listPermissionIdByRoleId",{roleId:roleId},function(data){			
                			 ...
                			 $.each(data,function(i,e){
                				...
                				var node = treeObj.getNodeByParam("id",permissionId,null);
                			 	...
                			 	//给已有的打勾
                				treeObj.checkNode(node,true,false,false);//不联动 不回调 
                			 })
                		});
            		});
